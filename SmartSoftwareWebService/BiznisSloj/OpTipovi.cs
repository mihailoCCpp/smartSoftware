...
namespace SmartSoftwareWebService.BiznisSloj
{
    ...
    public class OpTipoviOpremeInsert : OpTipovi
    {
        public override OperationObject execute( SmartSoftwareBazaEntities entities)
        {
            if (this.DataSelectTipoviOpreme != null)
    ...
    public class OpTipoviOpremeUpdate : OpTipovi
    {
        public override OperationObject execute(SmartSoftwareBazaEntities entities)
        {
            if (this.DataSelectTipoviOpreme != null)
    ...
    public class OpTipoviOpremeDelete : OpTipovi
    {
        public override OperationObject execute(SmartSoftwareBazaEntities entities)
        {
            if (this.DataSelectTipoviOpreme != null)
    ...
    public class OpTipoviOpremeRestore : OpTipovi
    {
        public override OperationObject execute(SmartSoftwareBazaEntities entities)
        {
            if (this.DataSelectTipoviOpreme != null)
    ...
    public class OpTipoviOpremePretraga : OpTipovi
    {
        public override OperationObject execute(SmartSoftwareBazaEntities entities)
        {
            DbItemTipOpreme[] niz =
