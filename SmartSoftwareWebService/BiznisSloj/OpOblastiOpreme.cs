...
namespace SmartSoftwareWebService.BiznisSloj
{
    ...
    public class OpOblastiOpremeInsert : OpOblastiOpremeBase
    {
        public override OperationObject execute(SmartSoftwareBazaEntities entities)
        {
            if(this.DataSelectOblastiOpreme != null)
    ...
    public class OpOblastiOpremeUpdate : OpOblastiOpremeBase
    {
        public override OperationObject execute(SmartSoftwareBazaEntities entities)
        {
            if (this.DataSelectOblastiOpreme != null)
    ...
    public class OpOblastiOpremeDelete : OpOblastiOpremeBase
    {
        public override OperationObject execute(SmartSoftwareBazaEntities entities)
        {
            if (this.DataSelectOblastiOpreme != null)
    ...
    public class OpOblastiOpremeRestore : OpOblastiOpremeBase
    {
        public override OperationObject execute(SmartSoftwareBazaEntities entities)
        {
            if (this.DataSelectOblastiOpreme != null)
    ...
    public class OpOblastiOpremePretraga : OpOblastiOpremeBase
    {
        public override OperationObject execute(DataSloj.SmartSoftwareBazaEntities entities)
        {
