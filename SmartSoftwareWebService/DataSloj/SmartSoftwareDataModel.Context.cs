...
namespace SmartSoftwareWebService.DataSloj
{
    ...
    public partial class SmartSoftwareBazaEntities : DbContext
    {
        ...
        public virtual int AzurirajKorpu(Nullable<int> idOprema, Nullable<int> kolicina)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("AzurirajKorpu", idOpremaParameter, kolicinaParameter);
        }
    
        public virtual int DodajUKorpu(Nullable<int> idOprema, Nullable<int> kolicina)
        {
            var idOpremaParameter = idOprema.HasValue ?
                new ObjectParameter("idOprema", idOprema) :
                new ObjectParameter("idOprema", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("DodajUKorpu", idOpremaParameter, kolicinaParameter);
        }
    
        public virtual int ObrisiCeluKorpu()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("ObrisiCeluKorpu");
        }
    
        public virtual int ObrisiOpremuIzKorpe(Nullable<int> idOpreme)
        {
            var idOpremeParameter = idOpreme.HasValue ?
                new ObjectParameter("idOpreme", idOpreme) :
                new ObjectParameter("idOpreme", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("ObrisiOpremuIzKorpe", idOpremeParameter);
        }
        ...
        public virtual int AzurirajBrojPoena(Nullable<int> idKorisnika, Nullable<int> izabranaKolicinaPoena)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("AzurirajBrojPoena", idKorisnikaParameter, izabranaKolicinaPoenaParameter);
        }
    
        public virtual int AzurirajRezervacije(Nullable<int> idOprema, Nullable<int> kolicina, Nullable<int> idRezervacije, Nullable<System.DateTime> datumIstekaRezervacije, Nullable<System.DateTime> datumAzuriranjaRezervacije)
        {
            var idOpremaParameter = idOprema.HasValue ?
                new ObjectParameter("idOprema", idOprema) :
                new ObjectParameter("idOprema", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("AzurirajRezervacije", idOpremaParameter, kolicinaParameter, idRezervacijeParameter, datumIstekaRezervacijeParameter, datumAzuriranjaRezervacijeParameter);
        }
        ...
        public virtual int DodajRezervacije(string ime, Nullable<System.DateTime> datum_rezervacije, Nullable<System.DateTime> datum_isteka_rezervacije, ObjectParameter idRezervacije)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("DodajRezervacije", imeParameter, datum_rezervacijeParameter, datum_isteka_rezervacijeParameter, idRezervacije);
        }
        ...
        public virtual int ZaposleniKorisniciInsert(string ime, string prezime, string mejl, string broj_telefona, string username, string lozinka, Nullable<int> broj_ostvareni_poena, Nullable<int> idUloge)
        {
            var imeParameter = ime != null ?
                new ObjectParameter("ime", ime) :
                new ObjectParameter("ime", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("ZaposleniKorisniciInsert", imeParameter, prezimeParameter, mejlParameter, broj_telefonaParameter, usernameParameter, lozinkaParameter, broj_ostvareni_poenaParameter, idUlogeParameter);
        }
    
        public virtual int ZaposleniKorisniciUpdate(Nullable<int> idKorisnika, string ime, string prezime, string mejl, string broj_telefona, string username, string lozinka, Nullable<int> broj_ostvareni_poena, Nullable<int> idUloge)
        {
            var idKorisnikaParameter = idKorisnika.HasValue ?
                new ObjectParameter("idKorisnika", idKorisnika) :
                new ObjectParameter("idKorisnika", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("ZaposleniKorisniciUpdate", idKorisnikaParameter, imeParameter, prezimeParameter, mejlParameter, broj_telefonaParameter, usernameParameter, lozinkaParameter, broj_ostvareni_poenaParameter, idUlogeParameter);
        }
        ...
        public virtual int DodajKorisnika(string ime, string prezime, string mejl, string broj_telefona, Nullable<int> idUloge)
        {
            var imeParameter = ime != null ?
                new ObjectParameter("ime", ime) :
                new ObjectParameter("ime", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("DodajKorisnika", imeParameter, prezimeParameter, mejlParameter, broj_telefonaParameter, idUlogeParameter);
        }
