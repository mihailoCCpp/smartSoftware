...
namespace SmartSoftwareWebService
{
    ...
    public class SmartSoftwareService : SmartSoftwareServiceInterface
    {
        ...
        public OperationObject KorpaInsert(int idOprema, int kolicina)
        {
        ...
        public OperationObject KorpaUpdate(int idOprema, int kolicina)
        {
        ...
        public DbItemOpremaSaParametrima[] KorpaDelete(int? idOprema)
        {
        ...
        public OperationObject RezervacijeInsert(DbItemOpremaSaParametrimaRezervacija[] rezervacija)
        {
            OpRezervacijeInsert op = new OpRezervacijeInsert();
            op.DataSelectOpremaRezervacija = new DbItemOpremaSaParametrimaRezervacija()
            {
                imeNaRezervacija = rezervacija[0].imeNaRezervacija,
            ...
            op.DataSelectRezervacijaNiz = rezervacija;
            OperationObject rezultat = OperationManager.Singleton.executeOp(op);
            return rezultat;
        }

        public OperationObject RezervacijeUpdate(int idOprema, int kolicina)
        {
            SmartSoftwareWebService.BiznisSloj.OpRezervacijeUpdate op = new OpRezervacijeUpdate();
            op.DataSelectOpremaRezervacija = new DbItemOpremaSaParametrimaRezervacija()
            {
                id_oprema = idOprema,
                kolicina_rezervisane_opreme = kolicina
            };
            OperationObject rezultat = OperationManager.Singleton.executeOp(op);
            return rezultat;
        }

        public DbItemOpremaSaParametrimaRezervacija[] RezervacijeDelete(int? idOprema)
        {
            ...
            OperationObject rezultat = OperationManager.Singleton.executeOp(op);
            DbItemOpremaSaParametrimaRezervacija[] niz = rezultat.Niz as DbItemOpremaSaParametrimaRezervacija[];
            return niz;
        }
