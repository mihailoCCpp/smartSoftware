...
namespace SmartSoftwareWebService
{
    ...
    public interface SmartSoftwareServiceInterface
    {
        ...
        [OperationContract]
        DbItemOpremaSaParametrima[] KorpaSelect();

        [OperationContract]
        OperationObject KorpaInsert(int idOprema,int kolicina);

        [OperationContract]
        OperationObject KorpaUpdate(int idOprema, int kolicina);

        [OperationContract]
        DbItemOpremaSaParametrima[] KorpaDelete(int? idOprema);
        ...
        [OperationContract]
        DbItemRezervacijaSaOpremom[] RezervacijeSelect();

        [OperationContract]
        OperationObject RezervacijeInsert(DbItemOpremaSaParametrimaRezervacija[] rezervacija);

        [OperationContract]
        OperationObject RezervacijeUpdate(int idOprema, int kolicina);

        [OperationContract]
        DbItemOpremaSaParametrimaRezervacija[] RezervacijeDelete(int? idOprema);
